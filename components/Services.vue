<template>
  <section id="services">
    <div class="bg-white dark:bg-gray-900 font-montserrat overflow-hidden" data-aos="fade-up">
      <div class="px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
        <div class="max-w-screen-lg lg:mb-16 mx-auto">
          <h1 class="mb-8 text-4xl sm:text-5xl tracking-tight font-bold text-blue-900 dark:text-white text-center">
            Our Services
          </h1>
        </div>
        <div class="grid gap-8 sm:gap-14 md:grid-cols-2 lg:grid-cols-3 md:gap-5">
          <div class="rounded-xl bg-customOrange-300 p-6 text-center shadow-xl " data-aos="zoom-in-up"
            data-aos-delay="200">
            <div
            ...
            <div class="btn mt-6">
              <a href="/storage"
                ...
                <span
                  ...
                  <svg class="w-6 h-6" fill="orange" stroke="black" viewBox="0 0 24 24"
                ...
                <span
                  class="absolute flex items-center justify-center w-full h-full text-white-500 transition-all duration-300 transform group-hover:translate-x-full ease">More
                  Detail</span>
          ...
          <div class="rounded-xl bg-customOrange-300 p-6 text-center shadow-xl " data-aos="zoom-in-up"
            ...
            <div
              class="mx-auto flex h-24 w-24 -translate-y-12 transform items-center justify-center rounded-full bg-orange-500 shadow-lg shadow-teal-500/40">
              <svg xmlns="http://www.w3.org/2000/svg" width="46" height="50" viewBox="0 0 448 512">
                <path fill="white"
          ...
          <div class="rounded-xl bg-customOrange-300 p-6 text-center shadow-xl" data-aos="zoom-in-up"
            ...
            <div
              ...
              <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 48 48">
                ...
                <path fill="white" d="M0 0h48v48H0z" mask="url(#ipTDelivery0)" />
              </svg>
            </div>
