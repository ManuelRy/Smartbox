<template>
  <div class="justify-center w-full font-montserrat">
    <nav class="bg-white dark:bg-gray-900 fixed z-1000 top-0 left-0 right-0 w-full border-b border-gray-200 dark:border-gray-600 shadow-md">
      <div class="max-w-screen-2xl flex flex-wrap items-center p-1 justify-between"> <!-- Added mx-2 for default and sm:mx-4 for small screens -->
        ...
        <div :class="menuClasses" class="items-center w-full md:flex md:w-auto md:order-1 ml-auto md:mr-12" id="navbar-sticky">
